...
VALUES ('Groceries',
       ...
       ('Debt Payment',
        ...
        'expenditure'),
       ('Emergency',
        'Unexpected urgent expenditures',
        '#FFFFFF',
        '#FF1744',
        'expenditure'),
       ('Subscription',
...
VALUES ('Food & Dining',
       ...
       ('Transportation & Travel',
        'Vehicle expenditures, public transport, travel',
        '#FFFFFF',
        '#2196F3',
        TRUE,
        'expenditure'),
       ...
       ('Technology & Communication',
        ...
        'expenditure'),
       ('Miscellaneous',
        'Other expenditures not categorized elsewhere',
        '#FFFFFF',
        '#607D8B',
        TRUE,
        'expenditure');
...
VALUES ('Emergency Fund',
       ...
       ('Retirement',
        ...
        'saving_goal'),
       ('Education Fund',
        'Educational expenditures savings',
        '#FFFFFF',
        '#00BCD4',
        'saving_goal'),
       ('Wedding',
       ...
       ('Home Improvement',
        ...
        'saving_goal'),
       ('Medical Fund',
        'Healthcare and medical expenditures',
        '#FFFFFF',
        '#607D8B',
        'saving_goal'),
       ('Technology Upgrade',
...
('Emergency Fund 6 Months',
 ...
 'Emergency fund covering 6 months of expenditures',
 600000.00,
 (SELECT id FROM currencies WHERE symbol = 'ARS'),
 '2024-12-31',
 50000.00,
...
('Alex University Fund',
 ...
 'University education expenditures for Alex',
 1200000.00,
 (SELECT id FROM currencies WHERE symbol = 'ARS'),
 '2028-03-01',
 25000.00,
...
('Family Health Fund',
 ...
 'Medical emergencies and health expenditures',
 200000.00,
 (SELECT id FROM currencies WHERE symbol = 'ARS'),
 '2024-12-31',
 15000.00,
...
VALUES ('Monthly Contribution',
       ...
       ('expenditure Reduction',
        'Money saved from cutting expenditures',
        '#FFFFFF',
        '#607D8B',
        'savings_contribution'),
       ('Goal Acceleration',
...
CALL CreateTransfer(2, 1, 200.00, 82000.00, 410.000000, 500.00, '2024-02-03 14:30:00',
                    'USD to ARS conversion for expenditures');
