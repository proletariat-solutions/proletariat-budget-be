...
func (h HouseholdMemberRepository) Create(
	ctx context.Context,
	...
	if err != nil {
		return "", fmt.Errorf(
			"failed to get last inserted id: %w",
			err,
		)
	}
...
func (h HouseholdMemberRepository) Update(
	ctx context.Context,
	id string,
	householdMember domain.HouseholdMember,
) error {
	...
	if errRowsAffected != nil {
		return fmt.Errorf(
			"failed to update household member: %w",
			errRowsAffected,
		)
	}
	if rowsAffected == 0 {
...
func (h HouseholdMemberRepository) Delete(
	ctx context.Context,
	id string,
) error {
	...
	if errRowsAffected != nil {
		return fmt.Errorf(
			"failed to delete household member: %w",
			errRowsAffected,
		)
	}
	if rowsAffected == 0 {
...
func (h HouseholdMemberRepository) Deactivate(
	ctx context.Context,
	id string,
) error {
...
func (h HouseholdMemberRepository) Activate(
	ctx context.Context,
	id string,
) error {
...
func (h HouseholdMemberRepository) GetByID(
	ctx context.Context,
	id string,
) (
...
func (h HouseholdMemberRepository) CanDelete(
	ctx context.Context,
	id string,
) (
	bool,
...
func (h HouseholdMemberRepository) List(
	ctx context.Context,
