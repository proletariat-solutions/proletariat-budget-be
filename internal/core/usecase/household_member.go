...
func (u *HouseholdMemberUseCase) ListHouseholdMembers(ctx context.Context, params *domain.HouseholdMemberListParams) (*domain.HouseholdMemberList, error) {
	return u.householdMembersRepo.List(ctx, params)
}
...
func (u *HouseholdMemberUseCase) UpdateHouseholdMember(ctx context.Context, id string, householdMember domain.HouseholdMember) error {
	_, err := u.householdMembersRepo.GetByID(ctx, id)
	if err != nil {
...
func (u *HouseholdMemberUseCase) DeleteHouseholdMember(ctx context.Context, id string) error {
	...
	canDelete, err := u.householdMembersRepo.CanDelete(ctx, id)
	if err != nil {
		return err
	}
	if !canDelete {
...
func (u *HouseholdMemberUseCase) GetHouseholdMemberByID(ctx context.Context, id string) (*domain.HouseholdMember, error) {
	member, err := u.householdMembersRepo.GetByID(ctx, id)
	if err != nil {
		if errors.Is(err, port.ErrRecordNotFound) {
...
func (u *HouseholdMemberUseCase) DeactivateHouseholdMember(ctx context.Context, id string) error {
	member, err := u.householdMembersRepo.GetByID(ctx, id)
	if err != nil {
		if errors.Is(err, port.ErrRecordNotFound) {
			return domain.ErrMemberNotFound
	...
	return u.householdMembersRepo.Deactivate(ctx, id)
}

func (u *HouseholdMemberUseCase) CanDeleteHouseholdMember(ctx context.Context, id string) (bool, error) {
	_, err := u.householdMembersRepo.GetByID(ctx, id)
	if err != nil {
		if errors.Is(err, port.ErrRecordNotFound) {
	...
	return u.householdMembersRepo.CanDelete(ctx, id)
}

func (u *HouseholdMemberUseCase) ActivateHouseholdMember(ctx context.Context, id string) error {
	member, err := u.householdMembersRepo.GetByID(ctx, id)
	if err != nil {
		if errors.Is(err, port.ErrRecordNotFound) {
			return domain.ErrMemberNotFound
	...
	return u.householdMembersRepo.Activate(ctx, id)
}
